...
/**
 * REST controller for managing {@link com.myproject.myapp.domain.BankAccount}.
 */
@RestController
...
public class BankAccountResource {
    ...
    /**
     * {@code GET  /bank-accounts/:id} : get the "id" bank account.
     *
     * @param id the id of the bank account to retrieve.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the bank account, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/{id}")
