...
import com.myproject.myapp.repository.NotificationRepository;
...
/**
 * REST controller for managing {@link com.myproject.myapp.domain.Notification}.
 */
@RestController
        ...
        Optional<Notification> result = notificationRepository
            ...
            .map(existingNotification -> {
                if (notification.getLogin() != null) {
                    existingNotification.setLogin(notification.getLogin());
                }
                ...
                if (notification.getChannel() != null) {
                    existingNotification.setChannel(notification.getChannel());
                }
