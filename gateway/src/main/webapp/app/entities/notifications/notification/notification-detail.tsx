    ...
    <Row>
      <Col md="8">
        <h2 data-cy="notificationDetailsHeading">
          <Translate contentKey="gatewayApp.notificationsNotification.detail.title">Notification</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{notificationEntity.login}</dd>
          <dt>
            <span id="title">
          ...
          <dd>
            {notificationEntity.readAt ? <TextFormat value={notificationEntity.readAt} type="date" format={APP_DATE_FORMAT} /> : null}
          </dd>
        </dl>
