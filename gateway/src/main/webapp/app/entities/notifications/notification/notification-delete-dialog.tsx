...
export const NotificationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.notificationsNotification.delete.question">
        <Translate contentKey="gatewayApp.notificationsNotification.delete.question" interpolate={{ id: notificationEntity.id }}>
