...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANALYSISREPORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ANALYSISREPORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ANALYSISREPORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ANALYSISREPORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ANALYSISREPORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ANALYSISREPORT actions', async () => {
      const arg = 42666;
