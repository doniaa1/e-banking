...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DATACOLLECTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DATACOLLECTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DATACOLLECTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DATACOLLECTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DATACOLLECTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DATACOLLECTION actions', async () => {
      const arg = 42666;
