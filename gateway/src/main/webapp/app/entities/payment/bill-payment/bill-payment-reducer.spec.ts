...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLPAYMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BILLPAYMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BILLPAYMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BILLPAYMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BILLPAYMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BILLPAYMENT actions', async () => {
      const arg = 42666;
