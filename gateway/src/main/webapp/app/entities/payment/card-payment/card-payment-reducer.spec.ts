...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDPAYMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CARDPAYMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARDPAYMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CARDPAYMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CARDPAYMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CARDPAYMENT actions', async () => {
      const arg = 42666;
