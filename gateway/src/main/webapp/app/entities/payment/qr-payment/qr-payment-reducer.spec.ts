...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QRPAYMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QRPAYMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QRPAYMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_QRPAYMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_QRPAYMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QRPAYMENT actions', async () => {
      const arg = 42666;
