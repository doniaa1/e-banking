...
import reducer, {
  ...
  reset,
  updateEntity,
} from './investment-activity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVESTMENTACTIVITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INVESTMENTACTIVITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INVESTMENTACTIVITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INVESTMENTACTIVITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INVESTMENTACTIVITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INVESTMENTACTIVITY actions', async () => {
      const arg = 42666;
