...
export const CustomerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.customersCustomer.delete.question">
        <Translate contentKey="gatewayApp.customersCustomer.delete.question" interpolate={{ id: customerEntity.id }}>
