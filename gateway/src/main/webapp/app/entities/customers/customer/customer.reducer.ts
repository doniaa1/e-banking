...
export const createEntity = createAsyncThunk(
  ...
  async (entity: ICustomer, thunkAPI) => {
    const cleanedEntity = cleanEntity({
      ...entity,
      nationalId: entity.nationalId || '123456789012', // Default national ID
      dateOfBirth: entity.dateOfBirth || dayjs().subtract(18, 'years'), // Default date of birth
    });
    const result = await axios.post<ICustomer>(apiUrl, cleanedEntity);
