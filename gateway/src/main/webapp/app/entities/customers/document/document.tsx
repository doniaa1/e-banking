  ...
  return (
    <div>
      <h2 id="document-heading" data-cy="DocumentHeading">
        <Translate contentKey="gatewayApp.customersDocument.home.title">Documents</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayApp.customersDocument.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/document/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.customersDocument.home.createLabel">Create new Document</Translate>
          </Link>
        </div>
      </h2>
        ...
        {documentList && documentList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gatewayApp.customersDocument.id">ID</Translate>{' '}
                ...
                <th>
                  <Translate contentKey="gatewayApp.customersDocument.customer">Customer</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {documentList.map((document, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`gatewayApp.DocumentType.${document.documentType}`} />
                  </td>
                  <td>
                  ...
                  <td>{document.customer ? <Link to={`/customer/${document.customer.id}`}>{document.customer.login}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.customersDocument.home.notFound">No Documents found</Translate>
            </div>
          )
        )}
      </div>
