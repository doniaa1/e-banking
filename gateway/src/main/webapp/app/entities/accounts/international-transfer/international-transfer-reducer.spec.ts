...
import reducer, {
  ...
  reset,
  updateEntity,
} from './international-transfer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERNATIONALTRANSFER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INTERNATIONALTRANSFER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INTERNATIONALTRANSFER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INTERNATIONALTRANSFER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INTERNATIONALTRANSFER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INTERNATIONALTRANSFER actions', async () => {
      const arg = 42666;
