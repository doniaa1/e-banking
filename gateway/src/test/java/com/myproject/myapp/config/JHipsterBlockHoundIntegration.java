...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.myproject.myapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.myproject.myapp.security.DomainUserDetailsService", "createSpringSecurityUser");
